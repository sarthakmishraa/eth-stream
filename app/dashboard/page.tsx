...
const Dashboard = () => {
    ...
    if(!data) {
        return(
            <p className="text-center text-2xl p-20 md:px-40 lg:px-60">Loading...</p>
        )
    }
    ...
    return(
        <div className="text-lg px-20 md:px-40 lg:px-60">
            <div className="flex flex-col items-center text-center space-y-4">
                <div>
                    <p className="text-4xl my-10 leading-snug tracking-tight font-bold">Select a cryptocurrency from the dropdown and click "Go" to view its real-time data.</p>
                    <p className="text-lg font-bold">Last updated on { lastUpdateTime }</p>
                </div>
